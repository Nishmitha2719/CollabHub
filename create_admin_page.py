#!/usr/bin/env python3
"""Quick script to create admin page"""
import os
...
print("Created app/admin/page.tsx successfully!")
print("\n NEXT STEPS:")
print("1. Run SQL schema in Supabase (supabase_collabhub_schema.sql)")
print("2. Make yourself admin: UPDATE profiles SET role='admin' WHERE email='your@email.com';")
print("3. Update pages to use real Supabase data (see SUPABASE_INTEGRATION_COMPLETE.md)")
print("4. Test the app: npm run dev")
